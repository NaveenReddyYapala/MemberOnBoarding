...
interface ILegalFormState {
  formData: any;
}

export default class LegalForm extends React.Component<ILegalFormProps, ILegalFormState> {
  constructor(props: ILegalFormProps) {
    super(props);
  ...
  render() {
    ...
    return (
      <div className={styles.memberBoardingForms}>
        <h3 className={styles.sectionsLabel}>Legal Action Form</h3>
        {/* <p>ID: {formData.Id}</p>
        ...
        <div className={styles.formRow}>
          <Dropdown
            ...
            onChanged={(option: IDropdownOption) =>
              this.handleInputChange('LegalAction', option.text)
            }
          />
          <TextField
            label="Legal Comment"
            ...
            onChanged={(newValue) =>
              this.handleInputChange('LegalComment', newValue)
            }
          />
        </div>
