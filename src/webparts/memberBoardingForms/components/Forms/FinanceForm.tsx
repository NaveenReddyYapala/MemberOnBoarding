...
interface IFinanceFormState {
  formData: any;
}

export default class FinanceForm extends React.Component<IFinanceFormProps, IFinanceFormState> {
  constructor(props: IFinanceFormProps) {
    super(props);
      ...
      <div className={styles.memberBoardingForms}>
        ...
        <div className={styles.formRow}>
          ...
          <TextField
            ...
            onChanged={(newValue) =>
              this.handleInputChange('FinanceComment', newValue)
            }
          />
        </div>
        <div>
